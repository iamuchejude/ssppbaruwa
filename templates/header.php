...
<body>
    ...
    <header class="clear">
        <div class="left logo">
            <a href="http://localhost/SPSquared/">
        ...
        <div class="right nav">
            <nav>
                <ul>
                    <li><a href="http://localhost/SPSquared/">Home</a></li>
                ...
                <a href="http://localhost/SPSquared/donate" class="modalActivator" data-mod="donate"><button data-mod="donate" class="joinUs">Donate</button></a>
            </nav>
        </div>
    </header>
